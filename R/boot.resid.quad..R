...
#'
#' \code{boot.resid.linear.plateau} is the core function to implement bootstrapping residuals on quadratic models, which assumes
...
#' @param plus_minus radius of random initial values (default: \code{10})
#' @param n.start total number of initial points considered (default: \code{20})
